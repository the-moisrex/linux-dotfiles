...
// Git Repo: https://github.com/ArthurSonzogni/FTXUI

int main() {
    vector<string> toggle_1_entries = {
        "On",
        "Off",
    };
    vector<string> toggle_2_entries = {
        "Enabled",
        "Disabled",
    };
    vector<string> toggle_3_entries = {
        "10€",
        "0€",
    };
    vector<string> toggle_4_entries = {
        "Nothing",
        "One element",
        "Several elements",
    };
